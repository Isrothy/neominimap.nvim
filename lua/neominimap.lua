...
M.refresh = function(args, opts)
    vim.deprecate("require('neominimap').refresh", "require('neominimap.api').refresh", "v5", "neominimap.nvim")
...
M.on = function(args, opts)
    vim.deprecate("require('neominimap').on", "require('neominimap.api').enable", "v5", "neominimap.nvim")
...
M.off = function(args, opts)
    vim.deprecate("require('neominimap').off", "require('neominimap.api').disable", "v5", "neominimap.nvim")
...
M.toggle = function(args, opts)
    vim.deprecate("require('neominimap').toggle", "require('neominimap.api').toggle", "v5", "neominimap.nvim")
...
---@return boolean
M.enabled = function()
    vim.deprecate("require('neominimap').enabled", "require('neominimap.api').enabled", "v5", "neominimap.nvim")
...
M.bufOn = function(args, opts)
    vim.deprecate("require('neominimap').bufOn", "require('neominimap.api').buf.enable", "v5", "neominimap.nvim")
...
M.bufOff = function(args, opts)
    vim.deprecate("require('neominimap').bufOff", "require('neominimap.api').buf.disable", "v5", "neominimap.nvim")
...
M.bufToggle = function(args, opts)
    vim.deprecate("require('neominimap').bufToggle", "require('neominimap.api').buf.toggle", "v5", "neominimap.nvim")
...
M.bufRefresh = function(args, opts)
    vim.deprecate("require('neominimap').bufRefresh", "require('neominimap.api').buf.refresh", "v5", "neominimap.nvim")
...
M.bufEnabled = function(bufnr)
    vim.deprecate("require('neominimap').bufEnabled", "require('neominimap.api').buf.enabled", "v5", "neominimap.nvim")
    if bufnr == nil then
        bufnr = 0
    end
...
M.winOn = function(args, opts)
    vim.deprecate("require('neominimap').winOn", "require('neominimap.api').win.enable", "v5", "neominimap.nvim")
...
M.winOff = function(args, opts)
    vim.deprecate("require('neominimap').winOff", "require('neominimap.api').win.disable", "v5", "neominimap.nvim")
...
M.winToggle = function(args, opts)
    vim.deprecate("require('neominimap').winToggle", "require('neominimap.api').win.toggle", "v5", "neominimap.nvim")
...
M.winRefresh = function(args, opts)
    vim.deprecate("require('neominimap').winRefresh", "require('neominimap.api').win.refresh", "v5", "neominimap.nvim")
...
M.tabOn = function(args, opts)
    vim.deprecate("require('neominimap').tabOn", "require('neominimap.api').tab.enable", "v5", "neominimap.nvim")
...
M.tabOff = function(args, opts)
    vim.deprecate("require('neominimap').tabOff", "require('neominimap.api').tab.disable", "v5", "neominimap.nvim")
...
M.winEnabled = function(winid)
    vim.deprecate("require('neominimap').winEnabled", "require('neominimap.api').win.wnabled", "v5", "neominimap.nvim")
    if winid == nil then
        winid = 0
    end
...
M.tabToggle = function(args, opts)
    vim.deprecate("require('neominimap').tabToggle", "require('neominimap.api').tab.toggle", "v5", "neominimap.nvim")
...
M.tabRefresh = function(args, opts)
    vim.deprecate("require('neominimap').tabRefresh", "require('neominimap.api').tab.refresh", "v5", "neominimap.nvim")
...
M.tabEnabled = function(tabid)
    vim.deprecate("require('neominimap').tabEnabled", "require('neominimap.api').tab.enabled", "v5", "neominimap.nvim")
    if tabid == nil then
        tabid = 0
    end
...
M.focus = function(args, opts)
    vim.deprecate("require('neominimap').focus", "require('neominimap.api').focus.on", "v5", "neominimap.nvim")
...
M.unfocus = function(args, opts)
    vim.deprecate("require('neominimap').unfocus", "require('neominimap.api').focus.off", "v5", "neominimap.nvim")
